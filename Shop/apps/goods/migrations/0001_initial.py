    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goos_brief', models.TextField(max_length=300, verbose_name='商品简短描述')),
                ('goods_desc', models.CharField(max_length=200, verbose_name='商品详细描述')),
                ('ship_free', models.BooleanField(default=True, verbose_name='是否承担运费')),
                ('goos_front_image', models.ImageField(blank=True, null=True, upload_to='', verbose_name='封面图片')),
                ('goods_front_image_url', models.CharField(default='', max_length=300, verbose_name='封面图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(default='', help_text='类别描述', max_length=150, verbose_name='类别描述')),
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(blank=True, help_text='父类目级别', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父类目级别')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', help_text='品牌名', max_length=10, verbose_name='品牌名')),
                ('desc', models.TextField(default='', help_text='商品描述', max_length=100, verbose_name='商品描述')),
