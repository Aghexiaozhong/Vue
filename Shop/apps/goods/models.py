...
class GoodsCategory(models.Model):
    ...
    desc = models.CharField(default='',max_length=150,verbose_name='类别描述',help_text='类别描述')
    category_type = models.IntegerField(choices=CATEGORY_TYPE,verbose_name='类目级别',help_text='类目级别')
    parent_category = models.ForeignKey('self',null=True,blank=True,verbose_name='父类目级别',help_text='父类目级别',related_name='sub_cat',on_delete=models.CASCADE)
...
class GoodsCategoryBrand(models.Model):
    ...
    name = models.CharField(default='',max_length=10,verbose_name='品牌名',help_text='品牌名')
    desc = models.TextField(default='',max_length=100,verbose_name='商品描述',help_text='商品描述')
...
class Goods(models.Model):
    ...
    goos_brief = models.TextField(max_length=300,null=True,verbose_name='商品详细描述')

    ship_free = models.BooleanField(default=True,verbose_name='是否承担运费')
    goos_front_image = models.ImageField(upload_to='goods/images/',null=True,blank=True,verbose_name='封面图')
