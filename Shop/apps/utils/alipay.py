...
class AliPay(object):
    ...
    def __init__(self, appid, app_notify_url, app_private_key_path,
        ...
        self.app_private_key_path = app_private_key_path  #文件路径私钥
        ...
        if debug is True:
            self.__gateway = "https://openapi.alipaydev.com/gateway.do"   #如果debug是true,则使用沙箱url
        else:
    ...
    def direct_pay(self, subject, out_trade_no, total_amount, return_url=None, **kwargs):
        ...
        biz_content.update(kwargs)   #除了上述四个必填参数，如果有其他参数，则添加进来
    ...
    def build_body(self, method, biz_content, return_url=None):
        ...
        if return_url is not None:
            data["notify_url"] = self.app_notify_url    #异步接受的接口
            data["return_url"] = self.return_url

        return data

    def sign_data(self, data):   #签名函数
        data.pop("sign", None)
        # 排序后的字符串
