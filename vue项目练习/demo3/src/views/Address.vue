      ...
      <div class="checkout-addr">
        ...
        <div class="addr-list-wrap">
          ...
          <div class="shipping-addr-more">
            <!--当limit大于3的时候，才会展开，more旁边的箭头变成向上-->
        ...
        <div class="next-btn-wrap">
          <!--next按钮，点击之后惊醒下一步 router-link传参数的方式  动态绑定to  v-bind:to 参数是query    -->
    ...
    export default {
        data(){
          return {
              addressList:[],
              limit:3,
              checkIndex:0 ,  //用来确定选中的地址
            modalConfirm:false,  //默认不显示这个模态框
              addressId:'',
            selectedAddrId:''
          }
        },
      ...
      methods:{
          ...
          expand(){
            //如果只是三条，那么当点击more那个箭头就会展开所有地址列表
              if(this.limit == 3){
